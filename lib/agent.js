    ...
    Agent = (function() {
        ...
        function heartbeat() {
            ...
            if(this.heartbeatSpec.payload) {
                    ...
                    if(_this.heartbeatSpec.payload.length == 1) {
                        ...
                        Q.nextTick(function() {
                            ...
                            Q.timeout(defer.promise, (_this.heartbeatSpec.interval-5) * 1000 || 25000).then(function(data) {
                                ...
                                promise = dispatchP(_this, "heartbeat", {payload: data, meta: {
                                    interval: _this.heartbeatSpec.interval
                                }});
                            }, function(err) {
                                // Send a late heartbeat without a payload
                                _this.log.warn(err, "Unable to produce heartbeat payload.");
                                promise = dispatchP(_this, "heartbeat", {meta: {
                                    interval: _this.heartbeatSpec.interval
                                }});
                            });
                        });
                        ...
                        _this.log.trace(data, "Heartbeat payload produced");
                        promise = dispatchP(this, "heartbeat", {payload: data, meta: {
                            interval: _this.heartbeatSpec.interval
                        }});
                    }
                ...
                promise = dispatchP(this, "heartbeat", {meta: {interval: _this.heartbeatSpec.interval}});

            // reprogram the next heartbeat
