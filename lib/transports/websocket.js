...
module.exports = (function() {
    ...
    Transport.prototype.init = function(opts) {
        ...
        this.ws.on('message', function(msg) {
            ...
            else if(content.key === 'command') {
                _this.log.debug("Executing command %s(%s)", content.key, content.uuid);
    ...
    Transport.prototype.send = function(sender, uuid, key, payload, options) {
        ...
        this.ws.send(JSON3.stringify(data), function(err) {
