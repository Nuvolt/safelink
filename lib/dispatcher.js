...
(function(){
    ...
    Dispatcher = (function(){
        ...
        /**
         * @method emitTo Emit an event to a specific agent only.
         * @param agentId The agent where the event is to be sent. This may be an array of agentIds.
         * @param key The event key that is being sent
         * @param data The event payload
         * @returns {*} A promise resolved when the event has been retrieved by the agent (or agents)
         */
        Dispatcher.prototype.emitTo = function(agentId, key, data) {
            var _this = this;
            var defer = Q.defer();
            Q.nextTick(function() {
