...
(function(){
    ...
    module.exports = {
        ...
        'execute-command-on': require('./execute-command-on'),
        'emit-to': require('./emit-to'),
        'post-command-progress': require('./post-command-progress'),
        'start-monitoring': require('./start-monitoring'),
        'stop-monitoring': require('./stop-monitoring')
    };
